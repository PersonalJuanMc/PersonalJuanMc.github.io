...
function printAwards() {
	...
	document.write("<td><img src='images/spacer.gif' width=105 height=5></td>");
	...
	if (r < 3)
		...
		document.write("<td><img src='images/foot_03.gif' width=148 height=61 alt='Award Ceremony' usemap='#awards' border='0'>");
...
function printIndexA() {
	...
	document.write('<td colspan=3><a href="../dragonfair.html"><img src="images/award_08.gif" width=79 height=61 border="0" alt="Dragon Fair menu"></a></td>');
}
